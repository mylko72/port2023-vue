  ...
  <section id="site">
        <div class="site__inner">
            ...
            <div class="site__wrap">
              <article v-for="(data, index) in siteText" class="site__item s1" :key="index">
                    <span class="num">{{ index+1 }}.</span>
                    <div class="text">
                        <div v-for="(txt, key) in data.text" :key="key">{{ txt }}</div>
                    </div>
                    ...
                    <div class="info">
                        <span v-for="(txt, key) in data.info" :key="key">{{ txt }}</span>
                    </div>
                </article>
            </div>
        </div>
