import { hasElementsNum, setPxToVw, callByObserver } from './monthly_function.js'
...
export default class ScrollMotion {
    ...
    constructor(sceneElem, motionElem, options){
    ...
    setObserver(){
        ...
        this.motionSelector.length && [...this.motionSelector].forEach((selector) => {
            ...
            let marginGap = window.innerWidth > 768 ? window.innerHeight * 0.1 : window.innerHeight * 0;
